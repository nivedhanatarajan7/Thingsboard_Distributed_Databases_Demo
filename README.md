...
- Connects to a local Apache Ignite cache
- Reads sensor-like data from the cache, like heart rate
- Sends the data to ThingsBoard using MQTT
- Verifies telemetry delivery status
